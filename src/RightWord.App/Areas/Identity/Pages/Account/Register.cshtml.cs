...
namespace RightWord.App.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToPage("RegisterConfirmation", new { email = Input.Email, agency = "RightWord", returnUrl = returnUrl });
                    }
                    else
                    {
                        //if (!string.IsNullOrEmpty(userRole["id"]))
        ...
        public async Task<IdentityResult> RoleRegister(IdentityUser user, string userRole)
        {
